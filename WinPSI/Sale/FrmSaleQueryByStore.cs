...
namespace WinPSI.Sale
{
    public partial class FrmSaleQueryByStore : Form
    {
        ...
        private void LoadSaleDataByStore()
        {
            ...
            PageModel<SaleQueryStoreModel> pageModel = RequestStar.GetSaleDataByStore(pModel, ucPager1.StartRecord, ucPager1.PageSize);
            if (pageModel != null)
            {
        ...
        private void tsbtnOutToExcel_Click(object sender, EventArgs e)
        {
            ...
            //条件查询出来的所有数据
            List<SaleQueryStoreModel> saleData = RequestStar.GetSaleDataByStore(paraModel, 1, 100000000).ReList;
