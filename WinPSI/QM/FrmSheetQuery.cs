        ...
        public partial class FrmSheetQuery : Form
        {
              ...
              /// <param name="e"></param>
                ...
                private void LoadSheetList()
                {
                        ...
                        //调用查询方法
                        PageModel<SheetInfoModel> pageModel = sheetBLL.GetSheetList(paraModel, ucPager1.StartRecord, ucPager1.PageSize);
                        if(pageModel != null )
                        {
                ...
                private void tsmiAllToExcel_Click(object sender, EventArgs e)
                {
                        ...
                        {
                                qModel.ShType = i;
                                List<SheetInfoModel> list = sheetBLL.GetSheetList(qModel, 1, 100000000).ReList;
                                if(list.Count >0)
