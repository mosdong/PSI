...
namespace WinPSI.Perchase
{
        public partial class FrmPerchaseQueryByGoods : Form
        {
                ...
                private void LoadPerDataByGoods()
                {
                        ...
                        PageModel<PerQueryGoodsModel> pageModel = perBLL.GetPerDataByGoods(pModel, ucPager1.StartRecord, ucPager1.PageSize);
                        if(pageModel!=null)
                        {
                ...
                private void tsbtnOutToExcel_Click(object sender, EventArgs e)
                {
                        ...
                        List<PerQueryGoodsModel> perData = perBLL.GetPerDataByGoods(qModel, 1, 100000000).ReList;
