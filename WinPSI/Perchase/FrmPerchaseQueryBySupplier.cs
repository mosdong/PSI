...
namespace WinPSI.Perchase
{
    public partial class FrmPerchaseQueryBySupplier : Form
    {
        ...
        private void LoadPerDataBySupplier()
        {
            ...
            PageModel<PerQuerySupplierModel> pageModel = RequestStar.GetPerDataBySupplier(pModel, ucPager1.StartRecord, ucPager1.PageSize);
            if (pageModel != null)
            {
        ...
        private void tsbtnOutToExcel_Click(object sender, EventArgs e)
        {
            ...
            //条件查询出来的所有数据
            List<PerQuerySupplierModel> perData = RequestStar.GetPerDataBySupplier(paraModel, 1, 100000000).ReList;
