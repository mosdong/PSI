...
namespace WinPSI.BM
{
    public partial class FrmUnitInfo : Form
    {
        ...
        {
            List<RegionInfoModel> provinces = RequestStar.GetProvinces();
        ...
        {
            List<RegionInfoModel> countries = RequestStar.GetCountries(cboCitys.SelectedValue.GetInt());
        ...
        {
            List<RegionInfoModel> cities = RequestStar.GetCities(cboProvinces.SelectedValue.GetInt());
