...
namespace WinPSI.BM
{
        public partial class FrmGoodsInfo : Form
        {
                ...
                {
                        GoodsInfoModel goodsInfo = goodsBLL.GetGoodsInfo(goodsId);
                        if(goodsInfo!=null)
                        {
                                ...
                                string gtypeName= gtBLL.GetGoodsType(goodsInfo.GTypeId).GTypeName;
                ...
                {
                        List<GoodsUnitInfoModel> list = guBLL.GetAllUnits(0);
